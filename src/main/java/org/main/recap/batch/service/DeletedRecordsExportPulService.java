...
public class DeletedRecordsExportPulService {
    ...
    private static final Logger logger = LoggerFactory.getLogger(DeletedRecordsExportPulService.class);
     ...
     */
    public String deletedRecordsExportPul(String scsbEtlUrl, String jobName, Date createdDate) {
