...
public class IncrementalExportCulTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        ...
        try {
            ...
            String resultStatus = incrementalExportCulService.incrementalExportCul(scsbEtlUrl, RecapConstants.INCREMENTAL_RECORDS_EXPORT_CUL, createdDate, exportStringDate);
            logger.info("Incremental Export CUL status : {}", resultStatus);
